...
Show a playable preview and invite revisions before the final encode when the workflow calls for approval. After approval, export MP4 to the **current project**, never to a global skill folder. Do not publish footage, render files, secrets, or a project repository to GitHub as part of ordinary video delivery.
